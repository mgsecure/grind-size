...
ground coffee within each square, using a small measuring spoon to
get a wide sample from the dosing cup.

It’s important to have as little clumping or overlap as possible.
The software has several mechanisms to break overlapping particles
up, but it’s still in progress. I’ve used a WDT tool to manually
break up clumps.

It’s also important that the images you load into the tool only have
four markers showing to make sure the template is accurately
recognized.
