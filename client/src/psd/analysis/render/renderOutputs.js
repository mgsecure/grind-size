...
export async function renderMaskPng(maskObj, width, height, originalImageData, validParticleIds = null, particles = [], meta = {}, options = {
    showParticles: true,
    showMarkers: true,
    showScale: true,
    showRoi: true
...
export async function renderOverlayPng(imageData, particles, meta = {}, options = {
    showParticles: true,
    showMarkers: true,
    showScale: true,
    showRoi: true
    ...
    */
    ...
    export async function renderDiagnosticPng(imageData, particles, maskObj, validParticleIds = null, meta = {}, options = {
        showParticles: true,
        showMarkers: true,
        showScale: true,
        showRoi: true
