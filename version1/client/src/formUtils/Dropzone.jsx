...
export default function Dropzone({
    ...
    const messageColor = lighten(backgroundColor, 0.8)
        ...
        <section className='container'>
            <div {...getRootProps({style})}>
                ...
                {converting
                    ? <LoadingDisplaySmall/>
                    : maxFilesHit
                        ? <p style={{textAlign: 'center', color: messageColor}}>Maximum Number of Files Added</p>
                        : <p style={{textAlign: 'center'}}>Drag Image{maxFiles > 1 ? 's' : ''} Here or<br/> Click to Browse</p>
                }
